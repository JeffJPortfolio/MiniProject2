    ...
    <div id="wrap">
        ...
        <div class="cart-layout">
            ...
            <div class="order-summary">
                <div class="order-box">
                    <p>주문금액: <span class="order-price"><fmt:formatNumber value="${goodsPrice}" type="number" />원</span></p>
                    <p class="total-price">총 주문금액(VAT 포함): <span class="total-price-value"><fmt:formatNumber value="${goodsPrice}" type="number" />원</span></p>
